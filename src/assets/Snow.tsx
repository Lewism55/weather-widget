...
const SnowIcon = ({size, ...rest}: IconProps) => (
    <svg xmlns='http://www.w3.org/2000/svg' viewBox={size === 'small' ? '0 0 60 60' : '0 0 70 70'} width={size === 'small' ? 24 : 80} height={size === 'small' ? 24 : 80} {...rest}>
        ...
        <g id='snowy-6' filter='url(#blur)'>
            ...
            >
                <path fill='none' stroke='#57A0EE' strokeLinecap='round' strokeWidth={1.2} d='M23 44.5v5' />
                <path fill='none' stroke='#57A0EE' strokeLinecap='round' d='m24.768 45.232-3.536 3.536M25.5 47h-5M24.768 48.768l-3.536-3.536' />
            </g>
            <g
                style={{
                    WebkitAnimationName: 'am-weather-snow',
            ...
            >
                <path fill='none' stroke='#57A0EE' strokeLinecap='round' strokeWidth={1.2} d='M31 44.5v5' />
                <path fill='none' stroke='#57A0EE' strokeLinecap='round' d='m32.768 45.232-3.536 3.536M33.5 47h-5M32.768 48.768l-3.536-3.536' />
            </g>
            <g
                style={{
            ...
            >
                <path fill='none' stroke='#57A0EE' strokeLinecap='round' strokeWidth={1.2} d='M40 44.5v5' />
                <path fill='none' stroke='#57A0EE' strokeLinecap='round' d='m41.768 45.232-3.536 3.536M42.5 47h-5M41.768 48.768l-3.536-3.536' />
            </g>
        </g>
    </svg>
)
