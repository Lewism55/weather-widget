...
const FogIcon = ({ size, ...rest }: IconProps) => (
    <svg
        ...
        viewBox={size === 'small' ? '0 0 60 60' : '0 0 64 64'}
        width={size === 'small' ? 24 : 72}
        height={size === 'small' ? 24 : 72}
        {...rest}
    >
        <g>
            <path fill='none' stroke='#d1d5db' strokeLinecap='round' strokeMiterlimit={10} strokeWidth={3} d='M17 20h30' />
            <animateTransform attributeName='transform' dur='2s' repeatCount='indefinite' type='translate' values='-3 0; 3 0; -3 0' />
        </g>
        <g>
            <path fill='none' stroke='#d1d5db' strokeLinecap='round' strokeMiterlimit={10} strokeWidth={3} d='M19 26h26' />
            <animateTransform attributeName='transform' begin='-0.2s' dur='2s' repeatCount='indefinite' type='translate' values='-4 0; 4 0; -4 0' />
        </g>
        <g>
            <path fill='none' stroke='#d1d5db' strokeLinecap='round' strokeMiterlimit={10} strokeWidth={3} d='M21.5 32h21' />
            <animateTransform attributeName='transform' begin='-0.4s' dur='2s' repeatCount='indefinite' type='translate' values='-5 0; 5 0; -5 0' />
        </g>
        <g>
            <path fill='none' stroke='#d1d5db' strokeLinecap='round' strokeMiterlimit={10} strokeWidth={3} d='M24 38h16' />
            <animateTransform attributeName='transform' begin='-0.6s' dur='2s' repeatCount='indefinite' type='translate' values='-6 0; 6 0; -6 0' />
        </g>
        <g>
            <path fill='none' stroke='#d1d5db' strokeLinecap='round' strokeMiterlimit={10} strokeWidth={3} d='M28 44h8' />
